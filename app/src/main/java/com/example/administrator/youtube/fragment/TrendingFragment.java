...
public class TrendingFragment extends Fragment implements VideoAdapter.onItemClickListener, OnLoadMoreListener {
    ...
    private class LoadVideo extends AsyncTask<Void, Void, ArrayList<Video>> {
        ...
        protected void onPostExecute(ArrayList<Video> videos) {
            ...
            if (videos != null) {
                ...
                mAdapter.setOnItemClickListener(TrendingFragment.this);
                mAdapter.setmOnLoadMoreListener(TrendingFragment.this);
            }
